...
for i in sub_dirnames:
	command = 'singularity run /share/PI/russpold/singularity_images/poldracklab_mriqc_0.14.2-2018-08-21-070e53b20a43.img $DATA_LOC/ $DATA_LOC/derivatives/mriqc_0.14.2/ participant -w $LOCAL_SCRATCH/work --participant_label ' + i + ' --mem_gb 50 --n_procs 10 --ants-nthreads 8 -vvv'
	print(command)
