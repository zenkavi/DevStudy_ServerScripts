...
for i in sub_dirnames:
	command = 'singularity run /share/PI/russpold/singularity_images/poldracklab_mriqc_0.10.4-2018-03-23-f1e4d5941533.img $DATA_LOC/ $DATA_LOC/derivatives/ participant -w $LOCAL_SCRATCH/work --participant_label ' + i + ' --mem-mb 50000 --nthreads 10 --omp-nthreads 8 -vv'
	print(command)
