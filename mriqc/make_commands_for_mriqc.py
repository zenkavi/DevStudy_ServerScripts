...
for i in sub_dirnames:
	command = 'singularity run /share/PI/russpold/singularity_images/poldracklab_mriqc_0.10.5-2018-05-28-9954e8c774c2.img $DATA_LOC/ $DATA_LOC/derivatives/mriqc_0.10.5/ participant -w $LOCAL_SCRATCH/work --participant_label ' + i + ' --mem-gb 50 --n_procs 10 --ants-nthreads 8 -vvv'
	print(command)
