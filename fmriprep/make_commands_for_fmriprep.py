...
for i in sub_dirnames:
	command = 'singularity run /share/PI/russpold/singularity_images/poldracklab_fmriprep_1.0.15-2018-05-17-ad916df843e8.img $DATA_LOC/ $DATA_LOC/derivatives/ participant -w work --participant_label ' + i + ' --mem-mb 50000 --nthreads 10 --omp-nthreads 8 -vv'
	print(command)
