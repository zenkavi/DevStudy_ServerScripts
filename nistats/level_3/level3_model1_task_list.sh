...
python level_3.py -m model1 -r hpe --runstats
python level_3.py -m model1 -r lpe --runstats
...
python level_3.py -m model1 -r var_sen --runstats
python level_3.py -m model1 -r ev_sen --runstats
