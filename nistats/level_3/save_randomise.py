    ...
    if len(randomise_results.outputs.tstat_files)>0:
        for i in range(0,len(randomise_results.outputs.tstat_files)):
            if tfce:
                ...
                os.rename(randomise_results.outputs.tstat_files[i], "%s/rand_%s_%s_tstat%s_cluster.nii.gz"%(in_path,mnum, reg, str(i+1)))
            print("***********************************************")
    ...
    if len(randomise_results.outputs.fstat_files)>0:
        for i in range(0,len(randomise_results.outputs.fstat_files)):
            if tfce:
                ...
                os.rename(randomise_results.outputs.fstat_files[i],"%s/rand_%s_%s_fstat%s_cluster.nii.gz"%(in_path,mnum, reg, str(i+1)))
            print("***********************************************")
    ...
    if len(randomise_results.outputs.t_p_files)>0:
        for i in range(0,len(randomise_results.outputs.t_p_files)):
            if tfce:
                ...
                os.rename(randomise_results.outputs.t_p_files[i], "%s/rand_%s_%s_t_p%s_cluster.nii.gz"%(in_path,mnum, reg, str(i+1)))
            print("***********************************************")
    ...
    if len(randomise_results.outputs.f_p_files)>0:
        for i in range(0,len(randomise_results.outputs.f_p_files)):
            if tfce:
                ...
                os.rename(randomise_results.outputs.f_p_files[i],"%s/rand_%s_%s_f_p%s_cluster.nii.gz"%(in_path,mnum, reg, str(i+1)))
            print("***********************************************")
    ...
    if len(randomise_results.outputs.t_corrected_p_files)>0:
        for i in range(0,len(randomise_results.outputs.t_corrected_p_files)):
            if tfce:
                ...
                os.rename(randomise_results.outputs.t_corrected_p_files[i],"%s/rand_%s_%s_cluster_corrp_tstat%s.nii.gz"%(in_path,mnum, reg, str(i+1)))
            print("***********************************************")
