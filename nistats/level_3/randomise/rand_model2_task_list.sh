...
randomise -i $MODEL_DIR/lpe/all_l2_model2_lpe.nii.gz -o $MODEL_DIR/lpe/rand_anova/group_diff -d $MODEL_DIR/lpe/model2_lpe.mat -t $MODEL_DIR/design.con -f $MODEL_DIR/design.fts -n 1000 -T
randomise -i $MODEL_DIR/hpe/all_l2_model2_hpe.nii.gz -o $MODEL_DIR/hpe/rand_anova/group_diff -d $MODEL_DIR/hpe/model2_hpe.mat -t $MODEL_DIR/design.con -f $MODEL_DIR/design.fts -n 1000 -T
